    ...
    <v-col cols="12" sm="12" md="12" :lg="mainPost ? 8 : 4">
        <v-card elevation="10" class="overflow-hidden card-hover" rounded="md">
            <div class="position-relative feature-card">
                <v-img class="align-start text-white" height="400" :src="post?.coverImg" :alt="post?.coverImg" cover
                    ...
                    <div class="pa-6 d-flex justify-space-between flex-column h-100 position-relative">
                        <div class="d-flex justify-space-between align-center">
                            ...
                            <v-chip class="text-body-2 font-weight-medium bg-primary" size="small" rounded="sm"
                                v-text="post?.category"></v-chip>
                        </div>
                        <div>
                            <h3 class="text-h3 text-20 my-6">
                                <RouterLink class="text-decoration-none color-inherits" :to="linkTo">{{ post?.title }}
                                </RouterLink>
                            </h3>
                            <div class="d-flex align-center justify-space-between">
                                ...
                                <div>
                                    ...
                                    <span class="text-subtitle-2 ml-2"
                                        v-text="format(new Date(post?.createdAt), 'E, MMM d')"></span>
                                </div>
                            </div>
                        </div>
                    </div>
